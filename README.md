...
| <a name="input_kinsumer_name"></a> [kinsumer\_name](#input\_kinsumer\_name) | The name of the kinsumer | `string` | n/a | yes |
| <a name="input_kinsumer_stream_name"></a> [kinsumer\_stream\_name](#input\_kinsumer\_stream\_name) | The full stream name the kinsumer is reading from | `string` | n/a | yes |
